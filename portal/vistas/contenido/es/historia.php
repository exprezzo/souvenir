...
<div style="position:relative; margin-top:0px; display:inline-block; margin-bottom:20px;">
	<div class="articulo paper" style="text-align:left;">
		...
		<h2 id="comunicado" style="margin: 0 0 0 0px;
color: black;
width: auto;
position: relative;
margin-bottom: 13px;"><a href="#comunicado">NUESTRA HISTORIA</a></h2>
		<p>
		...
		<div style="width:900px; display:inline-block; text-align:left; ">
