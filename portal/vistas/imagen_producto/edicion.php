	...
	$( function(){		
		var config={
			...
			catalogo:{
				...
				modelo:'Imagen_producto'
			},			
			pk:"id"
			
		};				
		 var editor=new Edicionimagen_producto();
		 editor.init(config);		
	});
</script>
...
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
	<label style="">Fk_producto:</label>
	<input type="text" name="fk_producto" class="txt_fk_producto" value="<?php echo $this->datos['fk_producto']; ?>" style="width:500px;" />
</div>
<div class="inputBox" style="margin-bottom:8px;display:block;margin-left:10px;width:100%;"  >
